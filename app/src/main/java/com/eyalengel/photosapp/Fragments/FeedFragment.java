package com.eyalengel.photosapp.Fragments;
...
public class FeedFragment extends Fragment
{
    ...
    {
        photosListView = (ListView)mainView.findViewById(R.id.lv_feed_photo);
        ...
        photosAdapter = new PhotosListAdapter(getActivity(), R.layout.photo_list_item, keys);
